  ...
  return (
    <main className="min-h-screen bg-cream pt-16">
      <section className="px-6 py-20 text-center sm:py-24">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-xl leading-relaxed text-text-secondary">Kaka comes with DeskBub at no cost. No account required. If you&apos;ve created a custom pet, sign in to get your pairing code.</p>
